...
const Password = ({id, website, username, password, dateAdded, onUpdate, onDelete }) => {
  ...
  return (
    <div className="p-3 pl-0 w-full flex items-center gap-4 text-white overflow-visible relative">
